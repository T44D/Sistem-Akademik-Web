                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <?php 
                            ...
                            $mapel = mysqli_query($conn, "SELECT * FROM mata_pelajaran WHERE kode_mata_pelajaran = '$kode_mapel'");
                            $getmapel = mysqli_fetch_array($mapel);
                            $mata_pelajaran = $getmapel['nama_mata_pelajaran'];
                        ?>
                        <h1 class="h4 mb-0 text-gray-800">Input Nilai <?php echo $mata_pelajaran." ".$kode_kelas; ?>
                        </h1>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='input_nilai_proses.php?kodejadwal=<?php echo $kodejadwal; ?>';"
                        ...
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='input_nilai_akhir_proses.php?kodejadwal=<?php echo $kodejadwal; ?>';"
                            style="cursor: pointer;">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">

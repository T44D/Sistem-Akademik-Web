              ...
              <div class="dropdown-divider"></div> -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800">Lihat Nilai Siswa/i</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <?php
            $cek = mysqli_query($conn, "SELECT * FROM jadwal WHERE nik = '$nik_login' GROUP BY kode_mata_pelajaran, kode_kelas ORDER BY kode_kelas");
            ...
            if ($row > 0) {
              ...
              ?>
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='pilih_lihat_nilai.php?kodejadwal=<?php echo $baris[0]; ?>';"

            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <?php
                        $query = mysqli_query($conn, "SELECT * FROM informasi_akademik WHERE no_info = '$no_info'");
                        while ($data = mysqli_fetch_array($query)) {
                            $img = array('png', 'jpg', 'jpeg');
                            $vid = array('mp4', 'webm', 'ogg');
                            ?>
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary"><?php echo $data['judul_info']; ?></h3>
                            <h6 class="m-0 font-weight-bold text-primary"><?php echo $data['tanggal_info']; ?></h6>
                        </div>
                        <div class="card-body">
                            <p><?php echo $data['deskripsi_info']; ?></p>
                        </div>
                        <div class="text-center">
                            <?php
                                if(in_array($data['media_info_tipe'], $img)) {
                                    ?>
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4"
                                src="../file/info_akademik/<?php echo $data['media_info']; ?>">
                            <?php
                                } elseif(in_array($data['media_info_tipe'], $vid)) {
                                    ?>
                            <video class="img-fluid px-3 px-sm-4 mt-3 mb-4" controls>
                                <source src="../file/info_akademik/<?php echo $data['media_info']; ?>"
                                    type="video/<?php echo $data['media_info_tipe']; ?>">
                            </video>
                            <?php
                                }
                            ?>

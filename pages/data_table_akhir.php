...
$excel->setActiveSheetIndex(0)->setCellValue('E1', "Deskripsi Nilai Pengetahuan");
$excel->setActiveSheetIndex(0)->setCellValue('F1', "Nilai Keterampilan");
$excel->setActiveSheetIndex(0)->setCellValue('G1', "Predikat Nilai Keterampilan");
$excel->setActiveSheetIndex(0)->setCellValue('H1', "Deskripsi Nilai Keterampilan");

            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        ?>
                        <h1 class="h4 mb-0 text-gray-800">Lihat Nilai <?php echo $mata_pelajaran." ".$kode_kelas; ?>
                        </h1>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='lihat_nilai_data.php?kodejadwal=<?php echo $kodejadwal; ?>';"
                        ...
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='lihat_nilai_akhir_data.php?kodejadwal=<?php echo $kodejadwal; ?>';"
                            style="cursor: pointer;">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">

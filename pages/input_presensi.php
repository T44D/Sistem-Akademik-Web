            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800">Presensi</h1>
                        <a href="input_presensi_manual.php"
                            class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-calendar-alt fa-sm text-white-50"></i> Input Presensi Manual</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <?php
          $cek = mysqli_query($conn, "SELECT * FROM jadwal WHERE nik = $nik_login ORDER BY kode_kelas ASC");
          $row = mysqli_num_rows($cek);
          if ($row > 0) {
            while ($baris = mysqli_fetch_array($cek)) {
                $jam_masuk = explode(":", $baris['jam_masuk']);
                $jamMasuk = (int) $jam_masuk[0].$jam_masuk[1];
                $jam_keluar = explode(":", $baris['jam_keluar']);
                $jamKeluar = (int) $jam_keluar[0].$jam_keluar[1];
                if ($baris['nama_hari'] == date('l')){
                if (cekStatus($jamMasuk, $jamKeluar)) {
                ...
                ?>
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='input_presensi_proses.php?kodejadwal=<?php echo $baris[0]; ?>';"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-m font-weight-bold text-warning text-uppercase mb-1">
                                                <?php echo $mapel[0]; ?></div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800"><?php echo $baris[6]; ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-l font-weight-bold text-warning text-uppercase mb-1">BELUM
                                                ADA JADWAL</div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800"><?php echo $baris[6]; ?>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">Silahkan Hubungi Admin
                                                untuk Registrasi Jadwal</div>
                                        </div>
                                    </div>
                                </div>
                            </div>

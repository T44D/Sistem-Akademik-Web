    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              $tahun = $ta[0];
              $data = mysqli_query($conn, "SELECT * FROM nilai_harian WHERE nisn = '$nisn_login' AND tahun <> '$tahun' ORDER BY kode_kelas ASC LIMIT 1");
              $row = mysqli_num_rows($data);
              if ($row > 0) {
              while ($baris = mysqli_fetch_assoc($data)) {
              ?>
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='lihat_nilai_history_data.php?kodekelas=<?php echo $baris['kode_kelas']; ?>';"

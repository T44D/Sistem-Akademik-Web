            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800">Nilai</h1>
                    </div>

                    <!-- Content Row -->
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='lihat_nilai_pts.php?kodekelas=<?php echo $data['kode_kelas']; ?>'"
                        ...
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='lihat_nilai_pas.php?kodekelas=<?php echo $data['kode_kelas']; ?>'"
                            style="cursor: pointer;">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">

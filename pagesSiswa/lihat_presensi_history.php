            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800">Pilih Tahun Ajaran</h1>
                    </div>
              ...
              $tahun = $ta[0];
              $data = mysqli_query($conn, "SELECT * FROM presensi WHERE nisn = '$nisn_login' AND tahun <> '$tahun' ORDER BY tahun ASC LIMIT 1");
              $row = mysqli_num_rows($data);
              if ($row > 0) {
              while ($baris = mysqli_fetch_assoc($data)) {
              ?>
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="location.href='lihat_presensi_history_data.php?tahun=<?php echo $baris['tahun']; ?>';"

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    if (password_verify($pd, $data['katasandi_siswa'])) {
                    ?>
                    <div class="alert alert-danger" role="alert">
                        <i class="fas fa-exclamation-triangle fa-sm"></i> Kata Sandi anda masih Kata Sandi
                        Awal. Silahkan Ganti Kata Sandi di Menu Profil
                    </div>
                    <?php
                    }
                    ?>
                    ...
                    <div class="card shadow mb-4" style="padding: 10px;">
                        ...
                        <br />
                        <?php
                        $query = mysqli_query($conn, "SELECT * FROM informasi_akademik");
                        while ($data = mysqli_fetch_array($query)) {
                            ?>
                        <div class="card mb-4"
                            onclick="location.href='detail_info.php?no_info=<?php echo $data['no_info']; ?>';"
                            style="cursor: pointer;">
                            <div class="card-header">
                                <?php echo $data['judul_info']; ?>
                            </div>
                            <div class="card-body"

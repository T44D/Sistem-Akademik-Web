    ...
    <?php 
        ...
        function tampilkan() {
            ...
            if (isset($_SESSION['login'])) {
                ...
                $cek = mysqli_query($conn, "SELECT * FROM tahun_ajaran");
                $data = mysqli_fetch_array($query);
                $ta = mysqli_fetch_array($cek);
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="lihat_nilai_history.php" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-calendar-alt fa-sm text-white-50"></i> History Nilai</a>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <button type="submit" name="print" form="form"
                            class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-calendar-alt fa-sm text-white-50"></i> Print Rapot PTS</button>
                        <?php 
                        ...
                        <meta http-equiv="refresh"
                            content="1;url=print_pts.php?nisn=<?php echo $nisn_login; ?>&kelas=<?php echo $kelas; ?>&semester=<?php echo $semester; ?>">
                        <?php
                        }
                        ?>
                    </div>
        ...
        $(document).ready(function() {
            $('#select_semester').change(function() {
                ...
                var kodekelas = "<?php echo $data['kode_kelas']; ?>";
                $.ajax({
                    url: "load_data_nilai.php",
                    method: "POST",
                    data: {
                        semester: semester,
                        nisn: nisn,

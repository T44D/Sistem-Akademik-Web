    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="import_guru.php" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            ...
                            <form class="user" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" aria-label="With textarea" placeholder="Alamat Guru"
                                        maxlength="300" required name="alamat_guru"></textarea>
                                </div>
                                <div class="form-group">
            ...
            if (isset($_POST['input_guru'])) {
              ...
              $insert = mysqli_query($conn, "INSERT INTO guru VALUES('$nik', '$nama_guru', '$gender', '$alamat_guru', '$hashed_password', 2, NULL)");

              if ($insert) {
                echo "<script>alert('Berhasil Menambahkan Guru dengan Nama $nama_guru')</script>";
              } else {

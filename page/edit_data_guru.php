        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <a href="lihat_data_guru.php?nik=<?php echo $nik; ?>">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulir Sunting Profil Guru</h6>
                        </div>
                        <div class="card-body">
                            <form class="user" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" maxlength="30"
                                        required name="nama_guru" value="<?php echo $row['nama_guru']; ?>">
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Nomor Induk Kepegawaian"
                                        required name="nik" value="<?php echo $row['nik']; ?>" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" value="Laki-Laki"
                                            <?php echo ($row['jenis_kelamin_guru']=='Laki-Laki')?'checked':'' ?>>
                                        <label class="form-check-label">
                                            Laki-Laki
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" value="Perempuan"
                                            <?php echo ($row['jenis_kelamin_guru']=='Perempuan')?'checked':'' ?>>
                                        <label class="form-check-label">
                                            Perempuan
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" aria-label="With textarea" placeholder="Alamat Guru"
                                        maxlength="70" required
                                        name="alamat_guru"><?php echo $row['alamat_guru']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary btn-user btn-block" name="update_guru"
                                        value="Sunting Data Guru">
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            if (isset($_POST['update_guru'])) {
              ...
              $alamat_guru = antiinjection($_POST['alamat_guru']);
        
              $update = mysqli_query($conn, "UPDATE guru SET nama_guru = '$nama_guru', jenis_kelamin_guru = '$gender', alamat_guru = '$alamat_guru' WHERE nik = '$nik'");

              if ($update) {
                echo "<script>alert('Berhasil Mengubah Data Guru dengan Nama $nama_guru')</script>";
                ?>
                    <meta http-equiv="refresh" content="1;url=lihat_data_guru.php?nik=<?php echo $nik; ?>">
                    <?php
              } else {
                echo "<script>alert('Gagal Mengubah Data Guru')</script>";
              }
            }
            ?>

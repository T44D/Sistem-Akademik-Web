                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Profil Data Siswa/i</h6>
                                </div>
                                <div class="card-body">
                                    <h6 class="medium font-weight-bold">Nomor Induk Siswa/i Nasional</h6>
                                    <h5> <?php echo $row['nisn']; ?> </h5>
                                    <br />
                                    <h6 class="medium font-weight-bold">Nomor Induk Siswa/i</h6>
                                    <h5> <?php echo $row['nis']; ?> </h5>
                                    <br />
                                    ...
                                    <h5> <?php echo $row['jenis_kelamin_siswa']; ?> </h5>
                                    <br />
                                    <h6 class="medium font-weight-bold">Tempat, Tanggal Lahir</h6>
                                    <h5> <?php echo $row['tempat_lahir']; ?>, <?php echo $row['tanggal_lahir']; ?>
                                    </h5>
                                    <br />
                                    <h6 class="medium font-weight-bold">Alamat</h6>
                                    <h5> <?php echo $row['alamat_siswa']; ?> </h5>
                                    <br />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    $status = $fetch['jenis_akun']; 
                                    if ($status == 0) {
                                    ?>
                                    <a href="blokir_siswa.php?nisn=<?php echo $row['nisn']; ?>&status=<?php echo $status; ?>"
                                        class="d-sm-inline-block btn btn-sm btn-success shadow-sm"
                                        onclick="return confirm('Anda Yakin Ingin Menghapus Blokir Akun ini?')">
                                    ...
                                    <a href="blokir_siswa.php?nisn=<?php echo $row['nisn']; ?>&status=<?php echo $status; ?>"
                                        ...
                                        onclick="return confirm('Anda Yakin Ingin Memblokir Akun ini?')">
                                        <i class="fas fa-exclamation-triangle fa-sm text-white-50"></i> Blokir
                                        Akun</a>
                                    <?php
                                    }
                                    ?>

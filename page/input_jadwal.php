    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            if (isset($_POST['input_jadwal'])) {
              ...
              $insert = mysqli_query($conn, "INSERT INTO jadwal VALUES(NULL, '$nama_hari', '$jam_masuk', '$jam_keluar', '$nik_guru', '$kode_mata_pelajaran', '$kode_kelas')");

              if ($insert) {
                echo "<script>alert('Berhasil Menambahkan Jadwal')</script>";
              } else {

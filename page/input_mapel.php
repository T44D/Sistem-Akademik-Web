    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulir Tambah Mata Pelajaran</h6>
                        </div>
                        <div class="card-body">
                            <form class="user" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Kode Mata Pelajaran"
                                        maxlength="2" required name="kode_mapel"
                                        onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Nama Mata Pelajaran"
                                        maxlength="50" required name="nama_mapel">
                                </div>
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary btn-user btn-block" name="input_mapel"
                                        value="Input Mata Pelajaran">
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            if (isset($_POST['input_mapel'])) {
              ...
              $insert = mysqli_query($conn, "INSERT INTO mata_pelajaran VALUES('$kode_mapel', '$nama_mapel')");

              if ($insert) {
                echo "<script>alert('Berhasil Menambahkan Mata Pelajaran')</script>";
              } else {
